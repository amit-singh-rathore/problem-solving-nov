class MinHeap:
	...
	def __bubbledown(self, idx):
		...
		smallest_idx = idx
		if len(self) > left_child_idx and self.heap[smallest_idx] > self.heap[left_child_idx]:
			smallest_idx = left_child_idx

		if len(self) > right_child_idx and self.heap[smallest_idx] > self.heap[right_child_idx]:
			smallest_idx = right_child_idx

		if smallest_idx != idx:
			self.__swap(idx, smallest_idx)
			self.__bubbledown(smallest_idx)